...
function allEvent() {
    ...
    sun.metadata = {
        ...
        volume: 'Volume: blablabla / 0.9 bumi misal',
        mass: 'Mass: asd / 0.9 bumi misal',
        gravity: 'Gravity: asd / 0.9 bumi misal',
        temperature: 'Temperature: asd / 0.9 bumi misal',
